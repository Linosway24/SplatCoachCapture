...
final class CoverageDiagnosticsTests: XCTestCase {
    ...
    func testCoverageDiagnosticsEncodeAuditableJSONAndCSVFields() throws {
        ...
        XCTAssertTrue(json.contains("\"targetEntryDwellDuration\":1"))
        XCTAssertTrue(json.contains("\"targetExitDwellDuration\":1.5"))
        XCTAssertTrue(json.contains("\"progressWindowDuration\":4"))
        XCTAssertTrue(json.contains("\"coachingState\""))
        XCTAssertTrue(json.contains("\"rawActiveSector\""))
        XCTAssertTrue(json.contains("\"debouncedInTarget\""))
        XCTAssertTrue(json.contains("\"targetEvidenceDelta\""))
        XCTAssertTrue(json.contains("\"guidanceDecisionReason\""))
